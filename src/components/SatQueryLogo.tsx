...
export const SatQueryLogo: React.FC<SatQueryLogoProps> = ({
  ...
  return (
    ...
    >
      ...
      {/* Background Stars (4-point sparkle) */}
      {/* Top-left Star */}
      ...
      {/* Back Half of Orbit Ring (behind Earth) */}
      <g opacity="0.5">
        <ellipse
          cx="96"
          cy="108"
      ...
      <g>
        ...
        {/* Clipped Continents & Landmasses */}
        <g clipPath="url(#earthClip)">
          {/* Earth Specular & Ambient Light */}
          <circle cx="95" cy="110" r="48" fill="url(#earthGloss)" />

          {/* Continents - High fidelity silhouettes matching the uploaded logo (Americas) */}
          <g fill="#e2e8f0" stroke="#f8fafc" strokeWidth="0.5" opacity="0.95">
            ...
            {/* Central America & Caribbean link */}
            ...
            {/* Right continent edge (Eurasia / Africa rim) */}
      ...
      {/* FRONT HALF OF ORBIT RING (glowing cyan-white elliptical ribbon) */}
      ...
      {/* Small Spherical Satellite / Orb Beacon on lower-left arc */}
      ...
      {/* UPPER-RIGHT SATELLITE (Detailed 3D Satellite) */}
      {/* Positioned at orbit intersection ~(132, 68), angled 40 deg */}
      <g transform="translate(132, 66) rotate(-38)">
        {/* Satellite Main Body / Chassis */}
        <rect
          x="-7"
          y="-8"
          width="14"
        ...
        {/* Parabolic Antenna Dish pointing down towards Earth */}
        <path
        ...
        {/* RIGHT SOLAR PANEL WING (6 Grid Cells) */}
        <g transform="translate(13, 0)">
          {/* Solar Panel Frame */}
          <rect
            x="0"
